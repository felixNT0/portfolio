      ...
      <div className="max-w-screen-lg px-6 mx-auto flex flex-col justify-center w-full h-full">
          ...
          <div className="p-10 rounded-[2.5rem] glass relative overflow-hidden group border-white/20 dark:border-white/5">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 leading-relaxed">
                Architecting high-impact digital products for global clients in{" "}
        ...
        <div className="md:w-2/3 space-y-12">
          ...
          >
            <div className="p-8 rounded-3xl glass border-white/20 dark:border-white/5 relative overflow-hidden group">
              ...
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 leading-relaxed relative z-10">
                Beyond architecting complex systems, I find balance in music. As
                a multi-instrumentalist playing both{" "}
                <span className="text-primary-600 dark:text-primary-400 font-bold">
                  Keyboard
                </span>{" "}
                and{" "}
                ...
                , I bring the same rhythm and precision to my code that I do to
                a melody.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl glass border-white/20 dark:border-white/5 relative overflow-hidden group">
              ...
              <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 leading-relaxed relative z-10">
                ...
                environments or collaborating across time zones, I believe that{" "}
          ...
          >
            ...
            secure backend system, I have the full-stack expertise to allow your
            business to scale."
          </motion.p>
        </div>
