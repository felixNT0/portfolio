      ...
      <div className="max-w-screen-lg px-6 mx-auto flex flex-col justify-center w-full h-full">
        <div className="space-y-12">
          <div className="text-center space-y-4">
            ...
            >
              A selection of my best work across E-commerce, FinTech, SaaS,
              EdTech, AgriTech, HealthTech, Real Estate, and Logistics. Each
              project represents a unique challenge solved with modern code and
          ...
          >
            {stats.map((stat, idx) => (
              ...
              >
                <div
                  className={`text-4xl font-black mb-2 ${stat.color} transition-transform group-hover:scale-110 duration-300`}
                >
                  {stat.value}
                </div>
